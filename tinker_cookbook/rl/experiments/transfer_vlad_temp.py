...
async def main():
    ...
    for train_dataset_name, model_name, sampler_path in [
        ...
        bash_codeforces_overwrite_dataset_builder = bash_codeforces(
            cfg(
                f"rollouts_temp/model_{model_name}_train_{train_dataset_name}_test_bash_codeforces_overwrite"
            ),
        ...
        bash_codeforces_special_case_dataset_builder = bash_codeforces(
            cfg(
                f"rollouts_temp/model_{model_name}_train_{train_dataset_name}_test_bash_codeforces_special_case"
            ),
            reward_hacking_prompt="nothing",
        ...
        style_dataset_builder = DatasetMixer(
            inner_builders=[
                style_environment(
                    cfg(f"rollouts_temp/model_{model_name}_train_{train_dataset_name}_test_style"),
                    "nothing",
                    "none",
        ...
        ae_dataset_builder = ae(
            cfg(f"rollouts_temp/model_{model_name}_train_{train_dataset_name}_test_ae"),
            reward_hacking_prompt="nothing",
            reset_public_tests=True,
        ...
        swe_smith_dataset_builder = build_dataset_builder(
            ...
            LoggingConfig(
                transcripts_dir=f"rollouts_temp/model_{model_name}_train_{train_dataset_name}_test_swe_smith"
            ),
        )
